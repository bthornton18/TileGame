...
//*** DESCRIPTION : This program plays an example of the tile game
//*** DATE        : 9/13/17
...
//#define WINDOW_NAME "Tile Game"			// Window name
//
////@@***********************************************************************************@@
//// Structures
//typedef struct pt
...
//	glVertex2i(bottomLeftPt.x, bottomLeftPt.y + recHeight);
//
//	glVertex2i(bottomLeftPt.x, bottomLeftPt.y + recHeight+1);
//	glVertex2i(bottomLeftPt.x, bottomLeftPt.y);
//	glEnd();
//
//	glFlush();
...
//	{
//		//turn users mouse click into a whole number row and column 
//		 if (y > 103) { // dont allow clicks above the play field
//
//			 int row = (x / 100);
//			 int column = ((WINDOW_YS - y) / 100);
//
//			 // convert the row/coulmn back into real cordinates and display the tile in the correct row/cloumn
//			 bottomLeftPt.x = row * 100 + 5;
//			 bottomLeftPt.y = column * 100 + 5;
//
//			 glutPostRedisplay();
//		 }
//	}
